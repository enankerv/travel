...
export default function PasteFormContent({
  onSubmit,
  onClose,
  isLoading,
  initialText = "",
  ...
  return (
    <>
      {listingUrl ? (
        <>
          <p style={{ margin: "0 0 0.5rem", fontWeight: 600, color: "var(--light)" }}>
            Copy the full listing page:
          </p>
          <ol
            style={{
              margin: "0 0 1rem",
          ...
          >
            ...
            <li>
              Select all: <kbd>Ctrl+A</kbd> (Windows) or <kbd>⌘A</kbd> (Mac)
            </li>
            <li>
              Copy: <kbd>Ctrl+C</kbd> (Windows) or <kbd>⌘C</kbd> (Mac)
            </li>
